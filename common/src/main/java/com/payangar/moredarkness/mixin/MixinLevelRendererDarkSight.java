...
public class MixinLevelRendererDarkSight {
    ...
    private void moreDarkness_beforeLateDebugPass(LevelRenderer instance, FrameGraphBuilder frame, CameraRenderState camera, GpuBufferSlice fog, Matrix4f modelViewMatrix) {
